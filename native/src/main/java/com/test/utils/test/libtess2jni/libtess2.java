...
package com.test.utils.test.libtess2jni;
...
public class libtess2 {
    ...
    static {
        try {
            ...
            com.github.fommil.jni.JniLoader.load(TAG + "." + ext);
    ...
    public static final class TESStesselator {
        ...
        private TESStesselator(final long nativePointer) {
     ...
     * @param unused unused
     */
    public static native void tessAddContour(TESStesselator tess, int coordsPerVertex,
            float[] contour, int strideBytes,
     ...
     * @return 0 on failure
     */
    public static int tessTesselate(final TESStesselator tess, final TessWindingRule windingRule,
            final TessElementType outputElementType,
            final int outputPolySize, final int outputVertexSize, final float[] normals) {
        ...
        //}
        return tessTesselate(tess, windingRule.ordinal(), outputElementType.ordinal(),
                outputPolySize, outputVertexSize,
                normals);
    }
